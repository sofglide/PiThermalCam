...
def camera_read(use_f: bool = True, filter_image: bool = False):
    ...
    try:
        while True:
            ...
            cv2.putText(img, text, (30, 18), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
            ...
            if file_saved_notification_start is not None and (time.monotonic() - file_saved_notification_start) < 1:
                cv2.putText(img, "Snapshot Saved!", (300, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2)
